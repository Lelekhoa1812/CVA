...
export async function POST(req: NextRequest) {
  ...
  const system = `You are a direct resume writing coach. Ask exactly 4 comprehensive questions total, ONE AT A TIME:
...
IMPORTANT: Ask ONLY ONE question at a time. Wait for the user's response before asking the next question. After the 4th question, say: <READY>.
